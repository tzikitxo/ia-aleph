            ...
            for (originalType in mouseEventTypes) {
                (function(originalType) {
                    document.addEventListener(originalType, function(originalEvent) {
                        ...
                        event.initMouseEvent(mouseEventTypes[originalType], true, true, window, 0, touch.screenX, touch.screenY, touch.clientX, touch.clientY, touch.ctrlKey, touch.altKey, touch.shiftKey, touch.metaKey, 0, null);

...
public class SourceDataService {
    ...
    private void loadData() {
        ...
        allFactionsData = Lists.newArrayList(Collections2.transform(unitDataByFaction.keySet(),
        ...
        if (unitData.isEmpty()) {
            ...
            return Iterables.find(unitData, new Predicate<UnitData>() {
                ...
                public boolean apply(UnitData unitData) {
                    return unitData.getArmy().equals(sessionService.getCurrentFaction());
                }
            });
        }
    }
    ...
    private abstract class FactionDataImpl implements FactionData {
    ...
    public static class UnitData implements Cloneable {
        ...
        public String getCleanIsc() {
            return isc.toLowerCase().replaceAll("[^a-z0-9]+", "_").replaceAll("(^_|_$)", "");
        }
